...
# Ruflins Great package

<!-- The Ruflins Great package integration allows you to monitor {name of service}. {name of service} is {describe service}.

Use the Ruflins Great package integration to {purpose}. Then visualize that data in Kibana, create alerts to notify you if something goes wrong, and reference {data stream type} when troubleshooting an issue.

For example, if you wanted to {sample use case} you could {action}. Then you can {visualize|alert|troubleshoot} by {action}. -->

## Data streams

<!-- The Ruflins Great package integration collects {one|two} type{s} of data streams: {logs and/or metrics}. -->
